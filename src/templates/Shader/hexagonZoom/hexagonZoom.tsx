...
import vertex from "./hexagonZoom.vert";
import fragment from "./hexagonZoom.frag";

const HexagonZoomMaterial = shaderMaterial(
    {
...
HexagonZoomMaterial.key = THREE.MathUtils.generateUUID();
extend({ HexagonZoomMaterial });
