...
import vertex from "./noiseGradient.vert";
import fragment from "./noiseGradient.frag";
...
// @ts-ignore
NoiseGradientMaterial.key = THREE.MathUtils.generateUUID();

extend({ NoiseGradientMaterial });

// shader material combined with mesh
const NoiseGradient: React.FC = (props: Mesh) => {
