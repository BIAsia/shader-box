...
import vertex from "./loadingMorph.vert";
import fragment from "./loadingMorph.frag";

// custom shader material
const LoadingMorphMaterial = shaderMaterial(
    {
...
// @ts-ignore
LoadingMorphMaterial.key = THREE.MathUtils.generateUUID();

extend({ LoadingMorphMaterial });

// shader material combined with mesh
const LoadingMorphBg: React.FC = (props: Mesh) => {
    ...
    return (
        ...
        >
            ...
            {/* @ts-ignore */}
            <loadingMorphMaterial
                key={LoadingMorphMaterial.key}
                ref={materialRef}
                uSpeed={speed}
